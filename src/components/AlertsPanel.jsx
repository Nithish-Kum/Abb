      ...
      <div className="alerts-panel">
        <div className="alerts-header">
          ...
          <div
            ...
            style={{
              background: alerts.length > 0 ? "var(--brand)" : "rgba(255, 91, 46, 0.08)",
              color: alerts.length > 0 ? "#fff" : "var(--ink-500)",
              transition: "all 0.3s"
            }}
          >
            {alerts.length}
        ...
        <div className="sensor-card fade-in" style={{ marginTop: "10px", borderColor: alerts.length > 0 ? "rgba(255, 91, 46, 0.25)" : "rgba(255, 91, 46, 0.12)" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginTop: "12px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontFamily: "var(--font-mono)", fontSize: "0.7rem" }}>
              <span style={{ color: "var(--rose)" }}>🔴 CRITICAL OUTSTANDING</span>
              <span style={{ fontWeight: 900, color: "var(--rose)" }}>{criticalCount}</span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontFamily: "var(--font-mono)", fontSize: "0.7rem" }}>
              <span style={{ color: "var(--brand)" }}>⚠ WARNING EVENTS</span>
              <span style={{ fontWeight: 900, color: "var(--brand)" }}>{warningCount}</span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontFamily: "var(--font-mono)", fontSize: "0.7rem" }}>
              <span style={{ color: "var(--sky)" }}>ℹ️ INFO LOGS</span>
              <span style={{ fontWeight: 900, color: "var(--sky)" }}>{infoCount}</span>
            </div>
          </div>

          <div style={{ borderTop: "1px dashed rgba(255, 91, 46, 0.15)", marginTop: "12px", paddingTop: "10px", fontSize: "0.6rem", color: "var(--ink-500)", fontFamily: "var(--font-mono)" }}>
  ...
  if (isOperator) {
    ...
    return (
      <div className="alerts-panel">
        ...
        <div className="sensor-card fade-in" style={{ borderColor: "rgba(255, 91, 46, 0.25)", marginTop: "10px" }}>
          <div className="gauge-title" style={{ borderBottom: "none", marginBottom: "6px", display: "flex", alignItems: "center", gap: "6px" }}>
            🤖 AI PILOT SUMMARY
          </div>
          <div style={{ fontFamily: "var(--font-mono)", fontSize: "0.72rem", color: "var(--ink-900)", marginBottom: "8px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "4px", margin: "10px 0" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: "0.58rem", fontFamily: "var(--font-mono)" }}>
              <span style={{ color: "var(--ink-500)" }}>CONFIDENCE INDEX</span>
              <span style={{ color: "var(--brand)", fontWeight: 900 }}>{confidenceVal}%</span>
            </div>
            <div style={{ height: "4px", background: "rgba(255, 255, 255, 0.05)", borderRadius: "2px", overflow: "hidden" }}>
              <div
                ...
                style={{
                  ...
                  boxShadow: "0 0 8px rgba(255, 91, 46, 0.4)",
          ...
          <div style={{ fontFamily: "var(--font-mono)", fontSize: "0.62rem", color: "var(--brand)", borderTop: "1px dashed rgba(255, 91, 46, 0.15)", paddingTop: "8px", marginTop: "8px" }}>
            💡 HINT: {actionableHint}
          </div>
        </div>
          ...
          {alerts.length === 0 ? (
            <div
              style={{
                ...
                border: "1px dashed rgba(255, 91, 46, 0.15)",
                borderRadius: "8px"
              }}
            >
            ...
            alerts.slice(0, 3).map(a => (
              <div key={a.id} className={`alert-item ${a.type}`} style={{ padding: "10px", borderRadius: "6px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "4px" }}>
                  ...
                  <span style={{ fontSize: "0.55rem", color: "var(--ink-500)", fontFamily: "var(--font-mono)" }}>{a.time}</span>
                </div>
                <div className="alert-msg" style={{ fontSize: "0.68rem", margin: "6px 0", color: "var(--ink-900)" }}>{a.msg}</div>
